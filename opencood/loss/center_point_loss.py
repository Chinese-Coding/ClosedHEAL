...
class CenterPointLoss(nn.Module):
    ...
    def forward(self, output_dict, target_dict, suffix=""):
        ...
        self.loss_dict.update({"total_loss": rpn_loss.item(), "reg_loss": box_loss.item(), "cls_loss": cls_loss.item()})
    ...
    def logging(self, epoch, batch_id, batch_len, writer=None, suffix=""):
        ...
        print(
            ...
            " || Loc Loss: %.4f" % (epoch, batch_id + 1, batch_len, suffix, total_loss, cls_loss, reg_loss)
        )
    ...
    def assign_targets(self, gt_boxes):
        ...
        all_targets_dict = {"heatmaps": heatmaps, "anno_boxes": anno_boxes, "inds": inds, "masks": masks}
    ...
    def get_targets_single(self, gt_bbox_3d, gt_labels_3d=None):
        ...
        for batch in range(batch_size):
            ...
            heatmap = gt_bbox_3d.new_zeros((1, feature_map_size[1], feature_map_size[0]))  # 辅助gt_bboxes_3d的属性
            ...
            for k in range(num_objs):
                ...
                if h > 0 and w > 0:
                    radius = gaussian_radius((h, w), min_overlap=self.target_cfg["gaussian_overlap"])
                    ...
                    if not (
                        0 <= center_int[0] < feature_map_size[0].item() and 0 <= center_int[1] < feature_map_size[1].item()
                    ):
                        continue
                    ...
                    assert center_int[1] * feature_map_size[0] + center_int[0] < feature_map_size[0] * feature_map_size[1]
