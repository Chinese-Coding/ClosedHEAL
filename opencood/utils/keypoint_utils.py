...
def seq_generate():
    dirs = [
        ...
        "/GPFS/rhome/yifanlu/workspace/dataset/OPV2V/validate" "/GPFS/rhome/yifanlu/workspace/dataset/OPV2V/test",
    ]
    ...
    for root_dir in dirs:
        ...
        scenario_folders_name = sorted([x for x in os.listdir(root_dir) if os.path.isdir(os.path.join(root_dir, x))])
            ...
            for j, cav_id in enumerate(cav_list):
                ...
                for timestamp in timestamps:
                    ...
                    if not os.path.exists(kp_path):
                        ...
                        kp_file = bev_sample(pcd_np, lidar_range, n_samples, mode="uniform", all_samples=True)
...
def parallel_generate(scenario_folder, scenario_folder_name):
    ...
    for j, cav_id in enumerate(cav_list):
        ...
        for timestamp in timestamps:
            ...
            all_keypoint = bev_sample(pcd_np, lidar_range, np.inf, mode="uniform", all_samples=True)
