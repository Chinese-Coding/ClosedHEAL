...
def generate_object_center_v2x(cav_contents, reference_lidar_pose):
    """
...
def generate_object_center(cav_contents, reference_lidar_pose):
    """
    Retrieve all objects in a format of (n, 7), where 7 represents
    x, y, z, l, w, h, yaw or x, y, z, h, w, l, yaw.
    ...
    for object_id, object_content in tmp_object_dict.items():
        ...
        bbx_lidar = corner_to_center(bbx_lidar, order=order)
        bbx_lidar = mask_boxes_outside_range_numpy(bbx_lidar, filter_range, order)
