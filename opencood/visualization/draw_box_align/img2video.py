...
projnames = [
    "/GPFS/rhome/yifanlu/OpenCOOD/opencood/logs/OPV2V_npj_v2xvit_w_2022_09_05_18_52_53/vis_0.4_0.4_0_0_video_vis",
...
for projname in projnames:
    ...
    size = (2560, 1920)
    out = cv2.VideoWriter(
        f'./result_video_cut_bev/v2xvit_{projname.split("/")[-1]}' + ".mp4", cv2.VideoWriter_fourcc(*"mp4v"), 10, size
    )
