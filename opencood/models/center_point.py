...
class CenterPoint(nn.Module):
    def __init__(self, args):
        ...
        self.cls_head = nn.Conv2d(input_channels, args["anchor_number"], kernel_size=1)
        self.reg_head = nn.Conv2d(input_channels, 8 * args["anchor_number"], kernel_size=1)
    ...
    def forward(self, data_dict):
        ...
        output_dict = {
            ...
            "reg_preds": bbox_temp,
            "bbox_preds": bbox,
        }  # 计算loss的时候使用 'bbox', 在生成output的时候 'rm'
