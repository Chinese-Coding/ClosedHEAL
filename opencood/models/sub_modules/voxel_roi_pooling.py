...
class VoxelRoIPooling(nn.Module):
    ...
    def roi_grid_pool(self, batch_dict):
        ...
        roi_grid_xyz, _ = self.get_global_grid_points_of_roi(rois, grid_size=self.grid_size)  # (BxN, 6x6x6, 3)
        ...
        for k, src_name in enumerate(self.model_cfg["features_source"]):
            ...
            pooled_features = pooled_features.view(-1, self.grid_size**3, pooled_features.shape[-1])  # (BxN, 6x6x6, C)
