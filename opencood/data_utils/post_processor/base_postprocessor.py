...
class BasePostprocessor(object):
    ...
    def generate_object_center(self, cav_contents, reference_lidar_pose, enlarge_z=False):
        ...
        box_utils.project_world_objects(
            tmp_object_dict, output_dict, reference_lidar_pose, filter_range, self.params["order"], enlarge_z
        )
    ...
    def generate_object_center_v2x(self, cav_contents, reference_lidar_pose):
        ...
        box_utils.project_world_objects_v2x(
            tmp_object_dict, output_dict, reference_lidar_pose, filter_range, self.params["order"], lidar_np=lidar_np
        )
    ...
    def generate_object_center_dairv2x(self, cav_contents, reference_lidar_pose):
        ...
        box_utils.project_world_objects_dairv2x(
            tmp_object_list, output_dict, reference_lidar_pose, filter_range, self.params["order"]
        )
    ...
    def generate_object_center_dairv2x_single(self, cav_contents, suffix=""):
        """
        Retrieve all objects in a format of (n, 7), where 7 represents
        x, y, z, l, w, h, yaw or x, y, z, h, w, l, yaw.
        ...
        box_utils.load_single_objects_dairv2x(tmp_object_list, output_dict, filter_range, self.params["order"])
    ...
    def generate_object_center_dairv2x_single_hetero(
        ...
        box_utils.load_single_objects_dairv2x_hetero(
            tmp_object_list, output_dict, filter_range, T_ego_cav, self.params["order"]
        )
    ...
    def generate_visible_object_center(self, cav_contents, reference_lidar_pose, enlarge_z=False):
        ...
        box_utils.project_world_visible_objects(
            tmp_object_dict, output_dict, ego_lidar_pose, inf_filter_range, self.params["order"], visibility_map, enlarge_z
        )
        ...
        box_utils.project_world_objects(
            updated_tmp_object_dict, output_dict, reference_lidar_pose, filter_range, self.params["order"], enlarge_z
        )
    ...
    def generate_object_center_v2xset_camera(self, cav_contents, reference_lidar_pose, enlarge_z=False):
