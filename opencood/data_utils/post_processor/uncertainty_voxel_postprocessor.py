...
class UncertaintyVoxelPostprocessor(VoxelPostprocessor):
    ...
    def post_process_stage1(self, stage1_output_dict, anchor_box):
        ...
        uncertainty = torch.masked_select(unc_preds.view(-1, uncertainty_dim), mask_sm[0]).view(
            -1, uncertainty_dim
        )  # [N*H*W*#anchor_num, 2] -> [num_select, 2]
        ...
        for n in batch_num_box_count:
            ...
            # nms
            keep_index = box_utils.nms_rotated(cur_corners, cur_scores, self.params["nms_thresh"])
