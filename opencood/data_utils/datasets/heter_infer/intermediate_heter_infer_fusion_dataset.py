...
def getIntermediateheterinferFusionDataset(cls):
    ...
    class Intermediate_heter_Infer_Fusion_Dataset(Intermediate_heter_Fusion_Dataset):
        ...
        def __init__(self, params, visualize, train=True):
            ...
            print(
                "Otherwise, modify it in opencood/data_utils/datasets/heter_infer/intermediate_heter_infer_fusion_dataset.py\n\n"
            )
        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                object_bbx_center, object_bbx_mask, object_ids = self.generate_object_center(
                    [selected_cav_base], ego_cav_base["params"]["lidar_pose_clean"]
                )
