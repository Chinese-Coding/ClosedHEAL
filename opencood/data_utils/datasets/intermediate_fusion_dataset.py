        ...
        def __getitem__(self, idx):
            ...
            for _i, cav_id in enumerate(cav_id_list):
                ...
                if self.visualize or self.kd_flag:
                    ...
                    if self.kd_flag:
                        processed_features_proj.append(selected_cav_processed["processed_features_proj"])
            ...
            if self.kd_flag:
                ...
                processed_data_dict["ego"].update(
                    {"teacher_processed_lidar": stack_feature_processed, "processed_lidar_proj": merged_feature_proj_dict}
                )
