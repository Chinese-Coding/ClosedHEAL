...
def getIntermediate2stageFusionDataset(cls):
    ...
    class Intermediate2stageFusionDataset(cls):
        ...
        def get_item_single_car(self, selected_cav_base, ego_cav_base):
            ...
            selected_cav_processed.update(
                {"object_bbx_center_no_coop": object_bbx_center[object_bbx_mask == 1], "single_label_dict": label_dict}
            )
        ...
        def __getitem__(self, idx):
            ...
            if self.load_lidar_file:
                ...
                processed_data_dict["ego"].update({"processed_lidar": merged_feature_dict, "vsa_lidar": vsa_lidar_stack})
            if self.load_camera_file:
            ...
            label_dict_coop = self.post_processor.generate_label(
                gt_box_center=object_bbx_center, anchors=self.anchor_box, mask=mask
            )

            label_dict = {"stage1": label_dict_no_coop, "stage2": label_dict_coop}  # list  # dict
        ...
        def collate_batch_train(self, batch):
            ...
            label_dict_no_coop_cavs_batch_list = [
                label_dict for label_dict_cavs_list in label_dict_no_coop_batch_list for label_dict in label_dict_cavs_list
            ]
        ...
        def collate_batch_test(self, batch):
            ...
            output_dict["ego"].update(
                {"sample_idx": batch[0]["ego"]["sample_idx"], "cav_id_list": batch[0]["ego"]["cav_id_list"]}
            )
