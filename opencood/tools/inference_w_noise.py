...
def test_parser():
    ...
    parser.add_argument(
        "--also_laplace", action="store_true", help="whether to use laplace to simulate noise. Otherwise Gaussian"
    )
    parser.add_argument(
        "--fusion_method", type=str, default="intermediate", help="no, no_w_uncertainty, late, early or intermediate"
    )
    parser.add_argument("--save_vis_interval", type=int, default=40, help="save how many numbers of visualization result?")
