...
def train_parser():
    ...
    parser.add_argument("--model_dir", default="", help="Place holder. NOT USED.")
...
def main():
    ...
    train_throughput, peak_memory_re, peak_memory_al = test_performance(
        model, train_loader, criterion, optimizer, supervise_single_flag
    )
